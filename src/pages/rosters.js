...
const RostersPage = () => {
  ...
  return (
    <Layout>
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-4 md:h-screen">
        <div className="bg-gray-800 text-white p-4 col-span-1 md:col-span-1">
          <ul>
            {teams.map((team) => (
              <li
                key={team.teamId}
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-sm text-gray-400">{team.displayName}</p>
                </div>
              </li>
            ))}
          </ul>
        ...
        <div className="bg-gray-200 p-4 col-span-1 md:col-span-3 overflow-x-auto">
          {selectedTeam ? (
            <div>
              <div className="flex flex-col md:flex-row items-center mb-4">
                ...
                <div className="flex flex-col text-center md:text-left">
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900">{selectedTeam.teamName}</h2>
                  <p className="text-gray-700 mt-1">{selectedTeam.displayName}</p>
                </div>
                <p className="text-gray-500 mt-2 md:ml-2">{selectedTeam.wins}-{selectedTeam.losses}</p>
              </div>
